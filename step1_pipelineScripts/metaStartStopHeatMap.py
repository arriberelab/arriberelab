...
Input: inFile.joshSAM - .joshSAM file
...
run as python metaStartStopHeatMap.py inFile.joshSAM 15 18 
...
def parseJoshSAMToDataFrame(inFile,
    ...
    """inFile is a .joshSAM file. Will look between
    ...
    with open(inFile,'r') as f:
        for line in f:
            if not line.startswith('@'):
                ...
                position=getPosition(line[6:],startOrStop)
                if position!='na':
