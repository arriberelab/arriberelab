...
Script to identify genes that have one and only one annotated
    transcript. Will also figure out their CDS length and txt length.
...
run as python identifyMonoTxtGenes.py annots.gtf outPrefix
"""
import sys, common
...
def parseAnnotationFile(annotFile):
    ...
    associated transcripts. Will return a pandas DataFrame of txtName,
    geneName,cdsLength,txtLength
    """
    aa={}
